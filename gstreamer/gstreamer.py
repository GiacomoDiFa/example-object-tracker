...
class GstPipeline:
    ...
    def on_new_sample(self, sink, preroll):
        ...
        with self.condition:
            self.gtsbuffer = sample.get_buffer()
            self.condition.notify_all()
